...
- (void)attributedLabel:(TLAttributedLabel *)label imageName:(NSString *)imageName messageId:(NSString *)messageId;
...
@property (weak, nonatomic) id<TLAttributedLabelDelegate> attributedLabelDelegate; /**< 消息代理事件 */;
