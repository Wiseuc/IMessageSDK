...
- (void)prepareUI {
    ...
    [_previewItem setTintColor:[UIColor blackColor]];
    ...
    _doneItem = [[UIBarButtonItem alloc] initWithTitle:@"发送" style:UIBarButtonItemStylePlain target:self action:@selector(clickFinishedButton)];
    _doneItem.enabled = NO;
    [_doneItem setTintColor:[UIColor blackColor]];
