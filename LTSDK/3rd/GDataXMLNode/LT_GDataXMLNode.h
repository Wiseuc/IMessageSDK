...
enum {
  LT_GDataXMLInvalidKind = 0,
  LT_GDataXMLDocumentKind,
  LT_GDataXMLElementKind,
  LT_GDataXMLAttributeKind,
  LT_GDataXMLNamespaceKind,
  LT_GDataXMLProcessingInstructionKind,
  LT_GDataXMLCommentKind,
  LT_GDataXMLTextKind,
  LT_GDataXMLDTDKind,
  LT_GDataXMLEntityDeclarationKind,
  LT_GDataXMLAttributeDeclarationKind,
  LT_GDataXMLElementDeclarationKind,
  LT_GDataXMLNotationDeclarationKind
};

typedef NSUInteger LT_GDataXMLNodeKind;
